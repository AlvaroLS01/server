...
public class DocumentoVentaImpresionServicio {
        ...
        public Optional<DocumentoVentaImpresionResultado> imprimir(String uidDocumento, OpcionesImpresionDocumentoVenta opciones) {
                ...
                try (ByteArrayOutputStream salida = new ByteArrayOutputStream()) {
                        ...
                        DocumentoVentaImpresionResultado respuesta = construirRespuesta(uidDocumento, opciones, configuracionImpresion, contenido);
        ...
        private DocumentoVentaImpresionResultado construirRespuesta(String uidDocumento, OpcionesImpresionDocumentoVenta opciones,
