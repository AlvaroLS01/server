...
public class DocumentoVentaImpresionServicio {
	...
	public DocumentoVentaImpresionServicio(SaleDocumentService saleDocumentService, @Qualifier("datosSesionRequest") ComerzziaDatosSesion datosSesionRequest) {
	...
	private DocumentoVentaImpresionRespuesta construirRespuesta(String uidDocumento, OpcionesImpresionDocumentoVenta opciones, PrintDocumentDTO configuracionImpresion, byte[] contenido) {
