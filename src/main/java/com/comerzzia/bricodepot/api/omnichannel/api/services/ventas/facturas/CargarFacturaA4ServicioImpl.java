...
import com.comerzzia.bricodepot.api.persistence.facturas.promociones.PromocionTicketDto;
import com.comerzzia.bricodepot.api.persistence.pagos.mediospago.DatosPeticionPagoTarjetaDto;
import com.comerzzia.bricodepot.api.persistence.pagos.mediospago.DatosRespuestaPagoTarjetaDto;
import com.comerzzia.bricodepot.api.persistence.pagos.mediospago.MediosPago;
import com.comerzzia.bricodepot.api.persistence.pagos.mediospago.MediosPagosMapper;
...
public class CargarFacturaA4ServicioImpl implements CargarFacturaA4Servicio {
	...
	@Override
        public void addFiscalData(TicketBean ticketBean, Map<String, Object> parametros) throws Exception, IOException {
	...
	@Override
        public void cargarDatosPagoTarjeta(TicketBean ticketVenta, TicketVentaAbono ticketVentaAbono, Map<String, Object> parametros) {
			...
			for (Element pago : listaPagos) {
				...
				if (nodeCodMegPag.equals("0010")) {
					...
					if (XMLDocumentUtils.getElement(pago, "datosRespuestaPagoTarjeta", true) != null) {
                        ...
                        parametros.put("listaPagosTarjetaDatosPeticion", listaPagosTarjetaDatosPeticion);
                        parametros.put("listaPagosTarjeta", listaPagosTarjeta);
                }
                catch (XMLDocumentException e) {
                        log.error("cargarDatosPagoTarjeta() - Ha habido un error: ", e);
                        parametros.put("listaPagosTarjetaDatosPeticion", null);
                        parametros.put("listaPagosTarjeta", null);
                }
        }
        @Override
        public void cargarPromociones(TicketBean ticketVenta, Map<String, Object> parametros) throws XMLDocumentException {
        ...
        private void addQR(String value, Map<String, Object> parametros) throws Exception {
                log.debug("addQR()");
                ...
                parametros.put("QR_PORTUGAL", is);
        }
        @Override
        public List<LineaTicket> getLineasAgrupadas(TicketVentaAbono ticketVenta) {
	...
	@Override
        public void getPagoGiftCard(TicketVentaAbono ticketVenta, Map<String, Object> parametros) {
